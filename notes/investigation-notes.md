# Investigation Notes — Sentinel Lab 08

## Investigation Overview

**Investigation Type:** Suspicious IP Investigation  
...
What activity is associated with `198.51.100.25`, and does the combined authentication and endpoint evidence justify treating the source as suspicious?
...
The IP should be investigated further using:

1. Threat-intelligence reputation.
2. IP ownership and infrastructure information.
3. VPN or proxy identification.
4. MFA and Conditional Access results.
5. Sign-in risk and authentication method.
6. Device information.
7. PowerShell Script Block Logging.
8. Process creation and child processes.
9. Network connections.
10. File activity.
11. Endpoint security alerts.
12. Decoded command content.

---

## Key Lesson

An IP should be treated as an investigation pivot.

The strongest evidence came from correlating:

**IP + multiple users + authentication results + time + endpoint activity**

This is more useful than making a conclusion from the IP address alone.
