# Troubleshooting Notes — Sentinel Lab 08
...
The investigation successfully demonstrated how an IP can be used as a pivot across identity and endpoint telemetry.

The main evidence chain was:
